...
class SalesTest < ApplicationSystemTestCase
  ...
  test "creating a Sale" do
    ...
    fill_in "Features", with: @sale.features
    fill_in "Make", with: @sale.make
    fill_in "Mileage", with: @sale.mileage
    fill_in "Model", with: @sale.model
    fill_in "Price", with: @sale.price
    fill_in "Year", with: @sale.year

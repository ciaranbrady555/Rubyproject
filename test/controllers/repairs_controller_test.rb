...
class RepairsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repair" do
    assert_difference('Repair.count') do
      post repairs_url, params: { repair: { make: @repair.make, model: @repair.model, plate: @repair.plate, status: @repair.status, work_needed: @repair.work_needed } }
    end
  ...
  test "should update repair" do
    patch repair_url(@repair), params: { repair: { make: @repair.make, model: @repair.model, plate: @repair.plate, status: @repair.status, work_needed: @repair.work_needed } }
